...
const URL_PLANILHA =
  "https://script.google.com/macros/s/AKfycbxqDhLWYyszMT7zFZTYhrv9Rp-QPT0tzE0_1vL8ey_cTV2B_NDCIOAytuCsL4QU_Sm9/exec";
  ...
  formulario.addEventListener("submit", (e) => {
    ...
    fetch(URL_PLANILHA, {
      ...
      .catch((erro) => {
        ...
        alert(
          "Erro ao salvar na nuvem, mas os dados estão salvos no seu navegador.",
        );
      });
  });
}
